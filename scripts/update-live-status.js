...
//
// Checks YouTube for live plane-spotting streams and writes the results to
// live-status.json. Runs on a 2-hour timer via GitHub Actions instead of in
// your browser, so your quota usage is now fixed and predictable.
